    ...
    <div v-if="loading"
      ...
      <div class="flex-col justify-between h-[100dvh] flex items-center relative">
        <svg :class="{ '!opacity-100 translate-x-0': fullSvg }"
          class="absolute top-[40%] opacity-0 transition-300 duration-300" width="123" height="81" viewBox="0 0 143 111"
